        ...
        <form className="customerForm">
            ...
            <fieldset>
                <div className="form-group">
                    ...
                    <input type="text" id="phoneNumber" onChange={handleControlledInputChange} required autoFocus className="form-control" placeholder="Customer phoneNumber" value={customer.phoneNumber} />
                </div>
            </fieldset>
            <fieldset>
                <div className="form-group">
